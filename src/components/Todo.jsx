    ...
    return (
        <div className="border-b border-gray-200 flex justify-between py-4">
            ...
            <div className="flex items-center">
                <MdDelete className="text-red-500 p-0 cursor-pointer hover:text-red-600 transition duration-300 ease-in mr-2" size="25" onClick={() => deleteTodo(index)} />
                <input type="checkbox" onChange={e => {
                    ...
                    }} className="cursor-pointer transition duration-300 ease-in h-[19px] w-[19px]" size="25" {... (checkListState === true ? {checked: true} : {checked: false})}  />
            </div>
        </div>
    );
}
